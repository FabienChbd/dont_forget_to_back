...
exports.view = exports.trash = exports.add = void 0;
var client_1 = require("@prisma/client");
var prisma = new client_1.PrismaClient();
var add = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, content, authorId, destId, result, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, content = _a.content, authorId = _a.authorId, destId = _a.destId;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, prisma.postIt.create({
                        data: {
                            content: content,
...
var trash = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, prisma.postIt.delete({
                        where: {
                            id: Number(id),
                        },
                    })];
...
var view = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, prisma.postIt.findMany({
                        where: {
...
exports.view = view;
//# sourceMappingURL=postItControllers.js.map